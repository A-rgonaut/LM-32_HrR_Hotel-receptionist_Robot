...
(l1:Hall {x: 10.0, y: 11.0, theta: 180.0}),
(l2:CoffeeRoom {x: 0.0, y: -5.0, theta: 0.0}),
(l3:Stanza {x: 7.0, y: 4.2, theta: 0.0, nome_camera: "Camera 1"}),
(l4:Stanza {x: 7.0, y: -1.8, theta: 0.0, nome_camera: "Camera 2"}),
(l5:Stanza {x: 7.0, y: -7.8, theta: 0.0, nome_camera: "Camera 3"}),
(l6:Stanza {x: 2.5, y: -12.3, theta: 270.0, nome_camera: "Camera 4"}),
(l7:Stanza {x: -2.5, y: -12.3, theta: 270.0, nome_camera: "Camera 5"}),
(l8:Stanza {x: -7.0, y: -7.8, theta: 180.0, nome_camera: "Camera 6"}),
(l9:Stanza {x: -7.0, y: -1.8, theta: 180.0, nome_camera: "Camera 7"}),
(l10:Stanza {x: -7.0, y: 4.2, theta: 180.0, nome_camera: "Camera 8"}),
